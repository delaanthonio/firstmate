...
This was hardened in two captain-directed no-mistakes review gate follow-ups: first by adding the home tag for primary-vs-secondmate collisions, then by hashing `FM_HOME` so distinct homes cannot collide even when they share one checkout.
