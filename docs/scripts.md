...
| `fm-turnend-guard.sh`    | Shared primary turn-end guard for watcher liveness and due standing checks (docs/turnend-guard.md) |
...
| `fm-supervision-lib.sh`  | Shared watcher-health predicates and serialized standing-check runner                 |
