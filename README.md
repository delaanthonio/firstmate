...
- **Two task shapes** - ship tasks deliver authorized changes with mode-appropriate review evidence; scout tasks leave standalone investigation reports when the intake contract warrants separate research.
