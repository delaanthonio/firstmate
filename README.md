...
- **Two task shapes** - ship tasks deliver a change with review-ready descriptions and UI evidence; scout tasks investigate, plan, reproduce, or audit and leave a report.
...
- A verified agent harness: Claude Code, Grok, Pi, Codex, OpenCode, or Droid.
