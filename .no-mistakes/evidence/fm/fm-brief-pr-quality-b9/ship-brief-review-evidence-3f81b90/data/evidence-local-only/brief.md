...
4. Report status by appending one line:
   `echo "{state}: {one short line}" >> '/Users/dela/.no-mistakes/evidence/01M33D2YJ4NXF34TPK8QJJ5MEE/ship-brief-review-evidence-3f81b90/state/evidence-local-only.status'`
...
Firstmate steers you through durable message files in '/Users/dela/.no-mistakes/evidence/01M33D2YJ4NXF34TPK8QJJ5MEE/ship-brief-review-evidence-3f81b90/state/evidence-local-only.inbox'.
When a terminal message says an instruction is waiting there - and at any natural checkpoint when you are unsure - list '/Users/dela/.no-mistakes/evidence/01M33D2YJ4NXF34TPK8QJJ5MEE/ship-brief-review-evidence-3f81b90/state/evidence-local-only.inbox'/*.msg, read and act on each message in numeric order, then acknowledge each handled message by moving it: `mv '/Users/dela/.no-mistakes/evidence/01M33D2YJ4NXF34TPK8QJJ5MEE/ship-brief-review-evidence-3f81b90/state/evidence-local-only.inbox'/NNN.msg '/Users/dela/.no-mistakes/evidence/01M33D2YJ4NXF34TPK8QJJ5MEE/ship-brief-review-evidence-3f81b90/state/evidence-local-only.inbox'/handled/`.
The move IS the acknowledgement: without it firstmate rings again and eventually treats you as stuck. An empty or absent inbox needs no action.

# Project memory
If `AGENTS.md` or `CLAUDE.md` already exists, or if this task produced durable project-intrinsic knowledge, run `/Users/dela/.no-mistakes/worktrees/51f31747dab7/01M33D2YJ4NXF34TPK8QJJ5MEE/bin/fm-ensure-agents-md.sh .` in the worktree.
Record only project knowledge useful to almost every future session.
For anything the codebase already shows, prefer a pointer to the authoritative file, command, or doc over copying the detail.
If you touch a project `AGENTS.md`, follow `/Users/dela/.no-mistakes/worktrees/51f31747dab7/01M33D2YJ4NXF34TPK8QJJ5MEE/bin/fm-ensure-agents-md.sh`'s self-governance contract in the same pass.
...
Save both files under `/Users/dela/.no-mistakes/evidence/01M33D2YJ4NXF34TPK8QJJ5MEE/ship-brief-review-evidence-3f81b90/data/evidence-local-only/shots/`, never commit them to the repo, and append `done: ready in branch fm/evidence-local-only; screenshots: /Users/dela/.no-mistakes/evidence/01M33D2YJ4NXF34TPK8QJJ5MEE/ship-brief-review-evidence-3f81b90/data/evidence-local-only/shots/` so firstmate can relay them for review.
...
When it is implemented and committed, append `done: ready in branch fm/evidence-local-only` with any evidence suffix required by the task instructions to the status file and stop.
