...
FM_DELIVERY_BUSY_REGEX_DEFAULT='esc (to )?interrupt|Working(\.\.\.|…)|Ctrl\+c:cancel|ctrl\+c to stop|Press ESC to stop|esc[[:space:]]+to[[:space:]]+cancel'
...
FM_DELIVERY_DROID_BUSY_REGEX_DEFAULT='Press ESC to stop'
