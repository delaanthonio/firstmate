...
# droid: "Press ESC to stop" (constant tail of its working footer, e.g.
# "Streaming... / Invoking tools... / Executing...  (Press ESC to stop)").
BUSY_REGEX=${FM_BUSY_REGEX:-'esc (to )?interrupt|Working\.\.\.|Ctrl\+c:cancel|Press ESC to stop'}
