...
# droid: "Press ESC to stop" (constant tail of its Streaming.../Invoking
# tools.../Executing... footer).
FM_TMUX_BUSY_REGEX_DEFAULT='esc (to )?interrupt|Working\.\.\.|Ctrl\+c:cancel|Press ESC to stop'
