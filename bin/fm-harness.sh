...
# Usage: fm-harness.sh                  print own harness: claude|codex|opencode|pi|pi-signed|grok|kimi|cursor|droid|gemini|muse|rovo|omp|agy|unknown
...
harness_marker() {
  ...
  # codex, opencode, kimi, muse, droid, and agy publish no harness-identity marker at all, so
