...
# Usage: fm-harness.sh                  print own harness: claude|codex|opencode|pi|pi-signed|grok|kimi|cursor|muse|droid|unknown
...
detect_own() {
  ...
  # opencode, Kimi, Muse, and Droid are markerless, so a foreign marker retained in a terminal
