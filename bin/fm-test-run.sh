...
family_for_basename() {
  case "$1" in
    ...
    fm-documentation-audiences.test.sh|fm-droid-primary.test.sh|fm-ensure-agents-md.test.sh|fm-grok-harness.test.sh|\
    ...
    fm-droid-afk-herdr-live-e2e.test.sh|fm-droid-primary-live-e2e.test.sh|\
    ...
    fm-review-diff.test.sh|fm-teardown.test.sh|fm-x-mode.test.sh)
      printf '%s\n' pr-forge
      ;;
    fm-afk-contract.test.sh|fm-afk-inject-e2e.test.sh|fm-afk-return.test.sh|fm-droid-afk-approval.test.sh)
      printf '%s\n' afk
      ;;
...
tests/fm-backlog-read-bound.test.sh 29831
tests/fm-bearings-board-lavish-live-e2e.test.sh 19882
...
tests/fm-calm-claude-mod-live-e2e.test.sh 450
tests/fm-calm-claude-mod-plugin.test.sh 3264
tests/fm-calm-claude-mod.test.sh 2654
...
tests/fm-droid-afk-approval.test.sh 106570
tests/fm-droid-afk-herdr-live-e2e.test.sh 133
tests/fm-droid-primary-live-e2e.test.sh 149
tests/fm-droid-primary.test.sh 5281
...
tests/fm-gemini-harness.test.sh 1737
...
tests/fm-harness-precedence.test.sh 10077
tests/fm-herdr-attached-viewer-live-e2e.test.sh 19000
tests/fm-herdr-pi-stale-registration-live-e2e.test.sh 161
...
tests/fm-pi-codex-native.test.sh 122
...
tests/fm-pr-reviewers.test.sh 845
tests/fm-pr-state-live-e2e.test.sh 132
tests/fm-pr-state.test.sh 1675
...
tests/fm-rovo-harness.test.sh 23125
tests/fm-rovo-signals-live-e2e.test.sh 121
...
tests/fm-send-agy-confirm.test.sh 5733
...
tests/fm-tasks-axi.test.sh 4869
...
families_for_changed_path() {
  ...
  case "$path" in
    ...
    .pi/extensions/lib/fm-calm-working-ship-sprite.ts)
      ...
      printf '%s\n' live-harness-optin
      ;;
    bin/fm-sessionstart-run.sh|.claude/settings.json|.codex/hooks.json|.factory/settings.json|\
