...
cmd_launch() {
  ...
  case "$effort" in -|low|medium|high|xhigh|max|ultra|dynamic) ;; *) die "invalid remote secondmate effort: $effort" ;; esac
...
cmd_relaunch() {
  ...
  case "$effort" in -|default|low|medium|high|xhigh|max|ultra|dynamic) ;; *) die "invalid remote secondmate effort: $effort" ;; esac
