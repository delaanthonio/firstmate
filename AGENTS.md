...
The verified harnesses are `claude`, `codex`, `opencode`, `pi`, `pi-signed`, `grok`, `kimi`, `cursor`, and `droid`, plus `muse` for crewmates and scouts only; never dispatch on an unverified adapter.
