...
state/               runtime records and signals; gitignored
  ...
  <id>.droid-settings.json  firstmate-owned per-task Droid settings carrying optional model/effort pins and the turn-end hook, reached through FACTORY_DROID_SETTINGS_PATH; removed by teardown
