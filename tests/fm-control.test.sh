...
VERIFIED_HARNESSES="claude codex opencode pi pi-signed grok kimi cursor muse droid omp"
...
test_harness_kind_capability() {
  ...
  for harness in claude codex opencode pi pi-signed grok kimi droid omp; do
