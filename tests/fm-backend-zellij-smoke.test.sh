...
FM_BACKEND_ZELLIJ_UNPUBLISHED_PANE_ID=$PANE_ID
FM_BACKEND_ZELLIJ_UNPUBLISHED_LABEL=$LABEL
FM_BACKEND_ZELLIJ_UNPUBLISHED_FINGERPRINT=$SESSION_FINGERPRINT_ONE
...
EOF
FM_BACKEND_ZELLIJ_UNPUBLISHED_SESSION=$SESSION
FM_BACKEND_ZELLIJ_UNPUBLISHED_TAB_ID=$_TAB_ID2
FM_BACKEND_ZELLIJ_UNPUBLISHED_PANE_ID=$PANE_ID2
FM_BACKEND_ZELLIJ_UNPUBLISHED_LABEL=$LABEL2
FM_BACKEND_ZELLIJ_UNPUBLISHED_FINGERPRINT=$SESSION_FINGERPRINT_TWO
