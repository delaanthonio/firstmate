...
# Keep the setup probe valid in the account's configured interactive shell.
# tmux may launch bash, zsh, fish, or another supported shell, so do not use a
# shell-specific prompt assignment here.
