...
tests/fm-turnend-guard.test.sh            # shared supervision predicate plus Claude Stop-hook scoping, due-check backstop, loop guard, fail-open, and live watcher health tests
